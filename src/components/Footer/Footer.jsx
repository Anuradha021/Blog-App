        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://github.com/Anuradha021" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                <FaGithub size={24} />
              </a>
              <a href="https://www.linkedin.com/in/anuradha-joshi-701422256/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                <FaLinkedin size={24} />
              </a>
              <a href="https://twitter.com/your-profile" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                <FaTwitter size={24} />
              </a>
            </div>
          </div>
          ...
          <div className="w-full md:w-2/3 flex flex-wrap justify-between">
            ...
            <div className="w-1/3 md:w-1/4 mb-6 md:mb-0">
              <h3 className="text-sm font-semibold uppercase text-gray-400 mb-4">Company</h3>
              <ul>
                <li className="mb-2">
            ...
            {/* Support Links */}
            <div className="w-1/3 md:w-1/4 mb-6 md:mb-0">
              <h3 className="text-sm font-semibold uppercase text-gray-400 mb-4">Support</h3>
              <ul>
                <li className="mb-2">
            ...
            <div className="w-1/3 md:w-1/4">
              <h3 className="text-sm font-semibold uppercase text-gray-400 mb-4">Legals</h3>
              <ul>
                <li className="mb-2">
